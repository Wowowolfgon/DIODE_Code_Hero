...
//    for(int i = 0; i<4; i++) {
//        ph0[i] = (unsigned char)buffer[i+11];//实时功率热量数据
//    }
	for(int i = 0; i<4; i++){
		ph01.c[i] = (unsigned char)buffer[i+11];//实时功率热量数据11
	}
